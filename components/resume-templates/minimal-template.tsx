  ...
  return (
    <div className="p-8 font-sans text-sm">
      ...
      <header className="mb-8">
        ...
        {data.personal.title && <p className="text-lg text-gray-600 mb-4">{data.personal.title}</p>}
        ...
        <section className="mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {data.skills.map((category, index) => (
              <div key={index}>
                {category.name && <h3 className="font-semibold text-gray-700">{category.name}</h3>}
                <p className="text-gray-700">
                  {category.skills
          ...
          {data.projects.map((project, index) => (
            <div key={index} className="mb-4">
              <div className="flex flex-col md:flex-row md:justify-between mb-1">
                ...
                {project.url && (
                  <a href={project.url} className="text-gray-600">
                    {project.url}
                  </a>
                )}
              </div>
